    ...
    <main class="tm-main">
        ...
        <div class="col-12">
          <form method="GET" class="form-inline tm-mb-80 tm-search-form">
            <input
              ...
              aria-label="Search"
            />
            <button class="tm-search-button" type="submit" @click.prevent>
      ...
      <div class="row tm-row">
        <article class="col-12 col-md-6 tm-post">
          ...
          <NuxtLink to="/post" class="effect-lily tm-post-link tm-pt-60">
        ...
        <article class="col-12 col-md-6 tm-post">
          ...
          <p class="tm-pt-30">
            <a
              ...
              >EXtra Blog</a
            >
            is a multi-purpose HTML CSS template. Blog list, single post, about,
            contact pages are included. Left sidebar fixed width and content
        ...
        <article class="col-12 col-md-6 tm-post">
          <hr class="tm-hr-primary" />
          <NuxtLink to="/post" class="effect-lily tm-post-link tm-pt-20">
            <div class="tm-post-link-inner">
              <img
        ...
        <article class="col-12 col-md-6 tm-post">
          ...
          <p class="tm-pt-30">
            ...
            strongly prohibited as we worked hard for this template.
          </p>
          <div class="d-flex justify-content-between tm-pt-45">
        ...
        <article class="col-12 col-md-6 tm-post">
          ...
          <NuxtLink to="/post" class="effect-lily tm-post-link tm-pt-20">
            ...
            <h2 class="tm-pt-30 tm-color-primary tm-post-title">
              Color hexa values of EXtra Blog
            </h2>
          </NuxtLink>
          <p class="tm-pt-30">
            If you wish to kindly support us, please contact us or contribute a
            small PayPal amount to info [at] example.com that is helpful for us.
            <br />
