    ...
    <main class="tm-main">
      ...
      <div class="row tm-row">
        <div class="col-12">
          ...
          <video width="954" height="535" controls autoplay class="tm-mb-40">
          ...
          <div class="tm-post-full">
            <div class="mb-4">
              <h2 class="pt-2 tm-color-primary tm-post-title">
                Single Post of EXtra Blog HTML Template
              </h2>
              ...
              <p>
                ...
                >
                from my Github repos. Phasellus maximus quis est sit amet
        ...
        <aside class="col-lg-4 tm-aside-col">
          <div class="tm-post-sidebar">
            ...
            <ul class="tm-mb-75 pl-5 tm-category-list">
              ...
              <li>
                <a href="#" class="tm-color-primary">Sed im justo diam</a>
              </li>
            </ul>
            <hr class="mb-3 tm-hr-primary" />
